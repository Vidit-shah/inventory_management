$(document).ready(function(){
    ...
    $('#id_line_two_quantity, #id_line_two_unit_price, #id_line_two_discount, #id_line_two_total_price, #id_line_three_quantity, #id_line_three_unit_price, #id_line_three_discount, #id_line_three_total_price, #id_line_four_quantity, #id_line_four_unit_price, #id_line_four_discount, #id_line_four_total_price, #id_subtotal, #id_cgst, #id_cgst_value, #id_sgst, #id_sgst_value, #id_total').keyup(function(){
        ...
        // var line_two_unit_discount_text = $('#id_line_two_unit_discount').val();
        // var line_two_total = (line_two_quantity_text * line_two_unit_price_text)*(line_two_unit_discount_text/100)
