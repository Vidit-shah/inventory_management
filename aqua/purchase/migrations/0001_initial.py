    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_type', models.CharField(blank=True, choices=[('Invoice with GST', 'Invoice with GST'), ('Invoice without GST', 'Invoice without GST')], default='', max_length=50, null=True)),
            ],
        ),
    ]
